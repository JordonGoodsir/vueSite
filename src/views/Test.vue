...
<!-- {{getPath()}} -->
        <div id="box"></div> 
        <input v-on:change="changeColor" value="#f35e5e" type="color">   
        
        <div class="colorOptions">  
             <i v-on:click="scrollLeft" class="arrow left"></i>
            <div id="colorHolder"> 
             
            
            <div v-for="color in colorPalette" :key="color"> 
              <div class="circle" v-on:click="changeBoxColor" v-bind:style="{backgroundColor: color}" v-bind:color="color"></div>  
            </div> 

            </div> 
            <!-- <button v-on:click="scroll_left">left</button>  -->
            <i v-on:click="scrollRight" class="arrow right"></i> 
...
<div>  
 ...
 width="196.000000pt" height="173.000000pt" viewBox="0 0 196.000000 173.000000">
<metadata>
Created by potrace 1.10, written by Peter Selinger 2001-2011
</metadata>
<g transform="translate(0.000000,173.000000) scale(0.050000,-0.050000)"
 stroke-width="5">
<path class="aiSvg" fill="white" stroke="#AEC6CF" stroke-width="110"  d="M2085 3350 c-148 -41 -324 -135 -455 -241 l-112 -91 -94 31 c-820
...
117 111z"/>
<path class="aiSvg" fill="white" stroke="#AEC6CF" stroke-width="110" d="M3170 2594 c-100 -33 -370 -245 -329 -257 36 -10 99 -9 99 2 0 19
...
98z"/>
<path  class="aiSvg" fill="white" stroke="#AEC6CF" stroke-width="110" d="M1835 2497 c-30 -11 -50 -29 -44 -39 20 -32 102 -19 139 22 43 47 6
54 -95 17z"/>
...
<path class="aiSvg" fill="white" stroke="#AEC6CF" stroke-width="110" d="M1680 1120 c-22 -22 -40 -34 -40 -26 0 7 -17 -4 -38 -25 -107 -111
-216 -129 -190 -30 5 17 -5 1 -22 -36 -17 -36 -50 -86 -72 -110 -192 -205
-113 -327 89 -138 246 229 400 405 356 405 -24 0 -61 -18 -83 -40z"/>
<path  class="aiSvg" fill="white" stroke="#AEC6CF" stroke-width="110" d="M3 235 c-2 -190 2 -235 25 -235 21 0 26 19 19 75 -5 41 -17 147 -26
235 l-16 160 -2 -235z"/>
<path class="aiSvg" fill="white" stroke="#AEC6CF" stroke-width="110" d="M3780 20 l-110 -13 125 -4 c72 -2 125 5 125 17 0 11 -7 19 -15 17 -8
-2 -64 -10 -125 -17z"/>
</g>
</svg>
...
export default { 
  ...
  data(){  
    return{
    something:"ye", 
    colorPalette: ["#ea907a","#fbc687","#f4f7c5","#aacdbe","#BEB4C5","#F5BFD2", "#A4CCE3"], 
    rowCount: 60,
		colCount: 80,
		color: "#ea907a",
		deletingState: false
  ...
  changeColor: function (event){ 
    ...
    scrollLeft() {
  let content = document.getElementById("colorHolder")
  ...
  let content = document.getElementById("colorHolder") 
    ...
    content.scrollLeft += 115; 
     ...
     changeBoxColor (event) { 
      document.getElementById("box").style.backgroundColor = event.target.attributes.color.value 
      this.color = event.target.attributes.color.value 
     }, 
     getPath (){ 
       var path = document.querySelector('.aiSvg');
